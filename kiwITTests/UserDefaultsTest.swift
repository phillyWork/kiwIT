...
final class UserDefaultsTest: XCTestCase {
    ...
    let accessKey = Setup.UserDefaultsStrings.accessKey
    let refreshKey = Setup.UserDefaultsStrings.refreshKey
    let accessToken = "65hUjL98IK"
    let refreshToken = "86hINj6gP8"
